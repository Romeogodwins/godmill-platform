...
export const metadata: Metadata = {
  title: "Family Accommodation in Taung | Godmill City Guesthouse",
  description:
    "Family accommodation in Taung with three-sleeper rooms, free WiFi, secure parking and a swimming pool at Godmill City Guesthouse.",
  alternates: {
    canonical: "https://www.godmillcityguesthouse.com/family-accommodation-taung",
  },
  openGraph: {
    title: "Family Accommodation in Taung | Godmill City Guesthouse",
    description:
      "Family accommodation in Taung with three-sleeper rooms, free WiFi, secure parking and a swimming pool at Godmill City Guesthouse.",
    url: "https://www.godmillcityguesthouse.com/family-accommodation-taung",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Family Accommodation in Taung",
        item: "https://www.godmillcityguesthouse.com/family-accommodation-taung",
      },
    ],
  };
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-36 lg:px-8">
          ...
          <p className="mt-12 uppercase tracking-[0.3em] text-[#d4b16f]">
            Family Stays in Taung
          </p>

          <h1 className="mt-4 max-w-5xl text-5xl font-bold leading-tight md:text-7xl">
            Family Accommodation in Taung
          </h1>

          <p className="mt-7 max-w-3xl text-xl leading-8 text-gray-200">
            Travelling to Taung with family? Godmill City Guesthouse offers comfortable three-sleeper rooms and convenient facilities for families and small groups.
          </p>
      ...
      <section className="px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-4 max-w-4xl text-4xl font-bold md:text-5xl">
            A Comfortable Base for Your Family Visit
          </h2>

          <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-300">
            Our family room options sleep up to three guests and are available with or without air conditioning. Guests also have access to WiFi, secure parking, private bathrooms and our swimming pool.
          </p>
