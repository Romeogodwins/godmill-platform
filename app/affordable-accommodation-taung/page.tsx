...
export const metadata: Metadata = {
  title: "Affordable Accommodation in Taung | Godmill City Guesthouse",
  description:
    "Find affordable accommodation in Taung at Godmill City Guesthouse. Rooms start from R500 per night with WiFi, secure parking and private bathrooms.",
  alternates: {
    canonical: "https://www.godmillcityguesthouse.com/affordable-accommodation-taung",
  },
  openGraph: {
    title: "Affordable Accommodation in Taung | Godmill City Guesthouse",
    description:
      "Find affordable accommodation in Taung at Godmill City Guesthouse. Rooms start from R500 per night with WiFi, secure parking and private bathrooms.",
    url: "https://www.godmillcityguesthouse.com/affordable-accommodation-taung",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Affordable Accommodation in Taung",
        item: "https://www.godmillcityguesthouse.com/affordable-accommodation-taung",
      },
    ],
  };
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-36 lg:px-8">
          ...
          <p className="mt-12 uppercase tracking-[0.3em] text-[#d4b16f]">
            Affordable Taung Accommodation
          </p>

          <h1 className="mt-4 max-w-5xl text-5xl font-bold leading-tight md:text-7xl">
            Affordable Accommodation in Taung
          </h1>

          <p className="mt-7 max-w-3xl text-xl leading-8 text-gray-200">
            Looking for comfortable accommodation in Taung at a competitive rate? Godmill City Guesthouse offers room options starting from R500 per night.
          </p>
      ...
      <section className="px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-4 max-w-4xl text-4xl font-bold md:text-5xl">
            Comfortable Rooms at Competitive Rates
          </h2>

          <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-300">
            Our standard rooms provide an affordable option for guests visiting Taung, while executive and three-sleeper family rooms offer additional choices depending on your needs and budget.
          </p>
