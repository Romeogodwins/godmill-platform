...
export const metadata: Metadata = {
  title: "Business Accommodation in Taung | Godmill City Guesthouse",
  description:
    "Business accommodation in Taung for professionals and work travellers. Godmill City Guesthouse offers WiFi, secure parking and comfortable rooms.",
  alternates: {
    canonical: "https://www.godmillcityguesthouse.com/business-accommodation-taung",
  },
  openGraph: {
    title: "Business Accommodation in Taung | Godmill City Guesthouse",
    description:
      "Business accommodation in Taung for professionals and work travellers. Godmill City Guesthouse offers WiFi, secure parking and comfortable rooms.",
    url: "https://www.godmillcityguesthouse.com/business-accommodation-taung",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Business Accommodation in Taung",
        item: "https://www.godmillcityguesthouse.com/business-accommodation-taung",
      },
    ],
  };
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-36 lg:px-8">
          ...
          <p className="mt-12 uppercase tracking-[0.3em] text-[#d4b16f]">
            Business Travel in Taung
          </p>

          <h1 className="mt-4 max-w-5xl text-5xl font-bold leading-tight md:text-7xl">
            Business Accommodation in Taung
          </h1>

          <p className="mt-7 max-w-3xl text-xl leading-8 text-gray-200">
            Godmill City Guesthouse provides comfortable accommodation for professionals, contractors and other business travellers visiting Taung.
          </p>
      ...
      <section className="px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-4 max-w-4xl text-4xl font-bold md:text-5xl">
            A Practical Stay for Business Travellers
          </h2>

          <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-300">
            With free WiFi, secure parking and a choice of comfortable rooms, Godmill City Guesthouse provides a convenient base for guests travelling to Taung for meetings, projects, training and other work commitments.
          </p>
