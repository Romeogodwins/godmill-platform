...
export const metadata: Metadata = {
  title: "Guesthouse in Taung | Godmill City Guesthouse",
  description:
    "Looking for a guesthouse in Taung? Stay at Godmill City Guesthouse with comfortable rooms, free WiFi, secure parking and a swimming pool. Book direct.",
  alternates: {
    canonical: "https://www.godmillcityguesthouse.com/guesthouse-taung",
  },
  openGraph: {
    title: "Guesthouse in Taung | Godmill City Guesthouse",
    description:
      "Looking for a guesthouse in Taung? Stay at Godmill City Guesthouse with comfortable rooms, free WiFi, secure parking and a swimming pool. Book direct.",
    url: "https://www.godmillcityguesthouse.com/guesthouse-taung",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "A Comfortable Guesthouse in Taung",
        item: "https://www.godmillcityguesthouse.com/guesthouse-taung",
      },
    ],
  };
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-36 lg:px-8">
          ...
          <h1 className="mt-4 max-w-5xl text-5xl font-bold leading-tight md:text-7xl">
            A Comfortable Guesthouse in Taung
          </h1>

          <p className="mt-7 max-w-3xl text-xl leading-8 text-gray-200">
            Godmill City Guesthouse offers comfortable accommodation for business travellers, couples, families and visitors looking for a convenient place to stay in Taung.
          </p>
      ...
      <section className="px-6 py-20 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <h2 className="mt-4 max-w-4xl text-4xl font-bold md:text-5xl">
            Your Guesthouse Stay in Taung
          </h2>

          <p className="mt-6 max-w-4xl text-lg leading-8 text-gray-300">
            Located at 217 Khibitswane, Cokonyane Road, Godmill City Guesthouse provides executive, standard and family room options with practical facilities for short visits, overnight stays and longer trips to Taung.
          </p>
