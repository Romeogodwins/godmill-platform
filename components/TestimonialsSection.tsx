    ...
    <section id="testimonials" className="bg-[#091b32] py-20">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        <div className="mb-12 text-center">
          <p className="text-sm uppercase tracking-[0.35em] text-[#d4b16f]">Guest reviews</p>
          <h2 className="mt-4 text-3xl font-semibold text-[#f8f2ea] sm:text-4xl">Trusted stays from local guests</h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-[#d9d1c6]">
            These are sample reviews until confirmed guest feedback is provided.
          </p>
        </div>
          ...
          {reviews.map((review) => (
            <article key={review.name} className="rounded-[2rem] border border-white/10 bg-[#0b1e3a]/80 p-8 text-[#d9d1c6] shadow-[0_30px_60px_-40px_rgba(0,0,0,0.8)]">
              ...
              <div className="mt-6 flex items-center justify-between gap-4">
                ...
                <span className="rounded-full bg-[#d4b16f]/15 px-3 py-1 text-[0.65rem] font-semibold uppercase tracking-[0.3em] text-[#f8f2ea]">
                  Sample
                </span>
              </div>
            </article>
